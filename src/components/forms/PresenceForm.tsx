    ...
    <Card className="rounded-2xl shadow-sm border-transparent bg-white overflow-hidden">
      <CardContent className="p-6 sm:p-8 space-y-6 sm:space-y-8">
        <div className="flex items-center gap-3">
          <div className="bg-indigo-50 p-2.5 rounded-xl flex items-center justify-center shrink-0">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`bg-slate-50 border-transparent focus-visible:ring-offset-0 focus-visible:bg-white h-11 sm:h-12 text-sm disabled:opacity-60 disabled:cursor-not-allowed ${
                errors.keyword
